...
export class DetalleAntecedentesComponent extends GeneralComponent {
    ...
    this.route.paramMap.subscribe(params => {
      ...
      if (cacheId) {
        ...
        if (datosRecuperados) {
          ...
          console.warn('Advertencia: No se encontraron datos para el ID de caché:', cacheId);
        }
  ...
  inicializatablagestion() {
    this.data = [
      {
        consecutivo: 1,
        expediente: "GST2023001",
        persona: "Ricardo Palma García",
        curp: "PAGR830521HDFRLC05",
        nss: "17482569321",
        fecha: "20-03-2022",
        descripcion: "El promovente manifestó retraso en ...",
        ooad: "OOAD Ciudad de México Norte",
        unidad: "HGZ No. 24 Insurgentes",
        notificacion: "20-03-2022",
        estado: "En trámite",
        cierre: "20-03-2022",
        resolucion: "20-03-2022",
        acuerdo: "20-03-2022",
        revoco: "Sí - 20-03-2022"
      },
      {
        consecutivo: 1,
        expediente: "GST2023001",
    ...
    this.data7 = [
      {
        ...
        folio: "GST2023001",
        persona: "Ricardo Palma García",
        peticionarios: "Ricardo Palma Hernández, María Fernanda ...",
        nss: "17482569321",
        fecha: "20-03-2022",
        ooad: "OOAD Ciudad de México Norte",
        unidad: "HGZ No. 24 Insurgentes",
      ...
      },
      {
        ...
        folio: "GST2023001",
        persona: "Ricardo Palma García",
        peticionarios: "Ricardo Palma Vázquez, Claudia  Méndez ...",
        nss: "17482569321",
        fecha: "20-03-2022",
        ooad: "OOAD Ciudad de México Norte",
        unidad: "HGZ No. 24 Insurgentes",
